...
i, data = list(enumerate(trainloader, 0))[0]
im_grid = torchvision.utils.make_grid(data['Image'][0])



writer.add_graph(net, data['Image'])
writer.close()
...
images, labels = select_n_random(data['Image'], data['Class'])
